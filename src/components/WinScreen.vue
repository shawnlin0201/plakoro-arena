...
const picSrc = computed(() => winner.value.character.imageUrl || `/image/CHARA/${winner.value.character.name}.png`)
</script>

<template>
  <div class="win-screen" :style="{ backgroundImage: `url('/image/BACK/back_${winner.character.type}.png')` }">
