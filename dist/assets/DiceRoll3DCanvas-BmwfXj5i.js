...
`].filter(as).join(`
`)),o=Zo(o),o=Tl(o,t),o=wl(o,t),a=Zo(a),a=Tl(a,t),a=wl(a,t),o=Al(o),a=Al(a),t.isRawShaderMaterial!==!0&&(M=`#version 300 es
...
`)+`
`+p);const w=M+m+o,S=M+p+a,T=yl(i,i.VERTEX_SHADER,w),b=yl(i,i.FRAGMENT_SHADER,S);i.attachShader(_,T),i.attachShader(_,b),t.index0AttributeName!==void 0?i.bindAttribLocation(_,0,t.index0AttributeName):t.hasPositionAttribute===!0&&i.bindAttribLocation(_,0,"position"),i.linkProgram(_);function C(P){if(r.debug.checkShaderErrors){const F=i.getProgramInfoLog(_)||"",N=i.getShaderInfoLog(T)||"",O=i.getShaderInfoLog(b)||"",I=F.trim(),D=N.trim(),k=O.trim();let q=!0,V=!0;if(i.getProgramParameter(_,i.LINK_STATUS)===!1)if(q=!1,typeof r.debug.onShaderError=="function")r.debug.onShaderError(i,_,T,b);else{const ne=bl(i,T,"vertex"),j=bl(i,b,"fragment");Xe("WebGLProgram: Shader Error "+i.getError()+" - VALIDATE_STATUS "+i.getProgramParameter(_,i.VALIDATE_STATUS)+`
